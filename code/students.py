...
# Examples of function usages - Uncomment and test as you please
# getAllStudents()
# addStudent('Michael', 'Jordan', 'michaeljordan@gmail.com', '2024-03-18')
# updateStudentEmail(1, 'john.doe.2024@newemail.com')
# deleteStudent(3)
